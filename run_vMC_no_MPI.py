...
from SSH_Hubbard.no_MPI_run import *
...
if (SR_run == True): 
    ...
    state_system, params, key, a, earr, parr = SR_n_iterations(n_SR_steps, int(n_sweeps), state_system, params, get_U_mat, log_amplitude_NOT_determinant, wf, wf_grad, wf_grad_X_phonons, wf_lapl_X_phonons, wf_grad_Y_phonons, wf_lapl_Y_phonons, key, a, dt_step, earr, parr, MAX_time)
...
##############################
    ...
    state_system, earr, observables = block_average(N_blocks, int(L_each_block), state_system, params, get_U_mat, log_amplitude_NOT_determinant, wf, wf_grad, wf_grad_X_phonons, wf_lapl_X_phonons, wf_grad_Y_phonons, wf_lapl_Y_phonons, key, a, earr, [corr_n_arr, Nq_arr, corr_s_arr, Sq_arr, corr_bx_arr, Bx_q_arr, corr_by_arr, By_q_arr, order_par_bond_x, order_par_bond_y, bond_amplitudes_arr_X, bond_amplitudes_arr_Y, X_diff_arr, Y_diff_arr, corr_dx_arr, corr_dy_arr, corr_dxy_arr, corr_d_onsite_arr ], MAX_time)

...
# Get the directory where lattice.py is located
current_dir = os.path.dirname(os.path.abspath(__file__))
# Build path to lattice.npy
lattice_file_path = os.path.join(current_dir, "Lattice_Maker", "lattice.npy")
...
# Opening ivic (table of neighbours) and checking everyhing works
with open(lattice_file_path, "rb") as file:

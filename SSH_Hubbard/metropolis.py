...
# Method to perfrom Nearest Neighbor hopping move
...
# Method to perfrom Nearest Neighbor Spin Flip move
@partial(jit, static_argnums=(2,))
...
# Method to perform a single Metropolis step
# This function is called in the loop of the Metropolis algorithm
@partial(jit, static_argnums=(2,3))
...
# Each sweep consists of a certain number of number of Metropolis steps
# At the end of each sweep, we compute the local observables
...
# Each sweep consists of a certain number of number of Metropolis steps
# This sweep is used for the Stochastic Reconfiguration
# The local observables are ONLY the ones needed for the SR
@partial(jit, static_argnums=(2,3,4,5,6,7,8))
...
# Performing many sweeps of the Metropolis algorithm
# and computing the local observables at each sweep
# This function is used for the Stochastic Reconfiguration
...
# Performing many sweeps of the Metropolis algorithm
# Discarding the local observables, since this is used for the Thermalization
@partial(jit, static_argnums=(0, 3, 4, 5, 6, 7, 8, 9))
